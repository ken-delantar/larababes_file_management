<aside class="w-70 bg-rose-800 dark:bg-gray-800 shadow-md h-full min-h-screen p-6">
    ...
    <nav>
        <ul>
            ...
            <li>
                ...
                {{-- <a href="{{ route('try') }}" class="block px-4 py-2 text-white dark:text-gray-300 hover:bg-rose-500 dark:hover:bg-blue-700 rounded transition duration-200">Add Student</a> --}}
                <a href="{{ route('trial') }}" class="block px-4 py-2 text-white dark:text-gray-300 hover:bg-rose-500 dark:hover:bg-blue-700 rounded transition duration-200">Document Management</a>
