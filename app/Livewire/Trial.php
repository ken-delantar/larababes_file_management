...
class Trial extends DataTableComponent
{
    ...
    public function builder(): Builder
    {
        $query = AcademicRecord::query()
            ...
            ->whereHas('section', function ($query) {
                $query->where('grade_level', 11); // Optional filter to only include grade 11 records
            });
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("LRN", 'student.lrn')->sortable()->searchable(),
            Column::make("S.Y", 'schoolYear.school_year'),
            ...
            Column::make("Status", "student.status")->sortable()->searchable(),
            Column::make('Actions')
